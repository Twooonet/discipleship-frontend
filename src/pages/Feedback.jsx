...
export default function Feedback() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
      <h1 className="text-2xl font-bold text-gray-800">Feedback & Suggestions</h1>
      ...
      {submitted ? (
        <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
          ...
          <p className="text-green-600 text-sm mb-4">Your feedback has been submitted. We appreciate you sharing your thoughts.</p>
          <button
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="font-semibold text-gray-700">Share your feedback</h2>
          </div>
          <p className="text-xs text-gray-400">Your feedback helps us grow as a group. You can submit anonymously.</p>
          <div>
          ...
          <div>
            <label className="block text-xs font-medium text-gray-600 mb-1">Feedback / Suggestion *</label>
            <textarea
              required
              value={form.content}
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-2.5 bg-primary-600 hover:bg-primary-700 disabled:opacity-60 text-white text-sm font-medium rounded-lg transition-colors"
          >
            ...
            <div className="space-y-2">
              {[1, 2].map(i => (
                <div key={i} className="bg-white rounded-xl border border-gray-100 p-4 animate-pulse">
                  <div className="h-3.5 bg-gray-200 rounded w-1/4 mb-2"></div>
                ...
                <div key={item.id} className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2 text-xs text-gray-400">
                      <span className="font-semibold text-gray-600">{item.author_name || 'Anonymous'}</span>
                      <span>•</span>
                  ...
                  <p className="text-gray-700 text-sm mt-2 whitespace-pre-wrap leading-relaxed">{item.content}</p>
                </div>
              ))}
            </div>
          )}
